...
export class Ticker {
  ...
  lastDeltas: number[];
  deltaAverage: number;
  elapsedUniform: ReturnType<typeof uniform>;
  deltaUniform: ReturnType<typeof uniform>;
  elapsedScaledUniform: ReturnType<typeof uniform>;
  deltaScaledUniform: ReturnType<typeof uniform>;
  events: Events;
  ...
  update(elapsed: number) {
    ...
    this.deltaAverage =
      this.lastDeltas.reduce((total, value) => total + value) / arrayLength;
